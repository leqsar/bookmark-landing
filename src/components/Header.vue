...
<template>
  <header class="header">
    <img class="logo" src="../assets/images/logo-bookmark.svg" alt="Company logo">
    ...
    <div class="mob-header-navigation-wrapper">
      <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg" class="mob-header-logo">
      ...
      <img class="close-icon" src="../assets/images/icon-close.svg" alt="Cross logo"  @click="openMenu">
      <ul class="mob-header-navigation">
        <li>feature</li>
        <li>pricing</li>
        <li>contact</li>
      </ul>
      <button class="mob-login-button">login</button>   
